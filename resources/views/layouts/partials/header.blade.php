...
>
    <div class="container mx-auto px-6 lg:px-12 flex justify-between items-center">
        ...
        <nav 
            ...
            :class="(scrolled || {{ request()->is('tentang-pesantren*', 'gallery-kegiatan*', 'guru-tendik*', 'berita*') ? 'false' : 'true' }}) ? 'text-gray-600' : 'text-white'"
        >
            @php
                $isDarkHeroPage = request()->is('tentang-pesantren*', 'gallery-kegiatan*', 'guru-tendik*', 'berita*');
            @endphp
        ...
        <button
            ...
            :class="(scrolled || !{{ request()->is('tentang-pesantren*') ? 'true' : 'false' }}) ? 'text-gray-700' : 'text-white'"
